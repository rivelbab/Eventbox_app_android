...
import com.eventbox.app.android.models.payment.TicketIdAndQtyWrapper
import com.eventbox.app.android.adapters.TicketSelectedListener
import com.eventbox.app.android.adapters.TicketsRecyclerAdapter
...
class TicketsFragment : Fragment() {
    private val ticketsRecyclerAdapter: TicketsRecyclerAdapter =
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val ticketSelectedListener = object :
            TicketSelectedListener {
    ...
    private fun redirectToAttendee() {
        val wrappedTicketAndQty =
            TicketIdAndQtyWrapper(
                ticketIdAndQty
            )
        findNavController(rootView).navigate(
            TicketsFragmentDirections.actionTicketsToAttendee(
    ...
    private fun redirectToLogin() {
        findNavController(rootView).navigate(
            TicketsFragmentDirections.actionTicketsToAuth(
