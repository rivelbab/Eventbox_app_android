...
import com.eventbox.app.android.utils.ImageUtils.encodeBitmap
import com.eventbox.app.android.utils.Utils.setToolbar
import com.eventbox.app.android.auth.CropImageFragmentArgs
import com.eventbox.app.android.auth.CropImageFragmentDirections
            ...
            val cropCallback: CropCallback = object : CropCallback {
                override fun onSuccess(cropped: Bitmap) {
                    ...
                    findNavController(rootView)
                        .navigate(
                            CropImageFragmentDirections.actionCropImageToEditProfilePop(
                                newEncodedImage
                            )
                        )
                }
