package com.eventbox.app.android.fragments.speakers
...
class SpeakersCallFragment : Fragment() {
        ...
        val dialogBuilder = AlertDialog.Builder(requireContext())
            ...
            .setPositiveButton(getString(R.string.create_proposal)) { _, _ ->
                findNavController(rootView).navigate(
                    SpeakersCallFragmentDirections.actionSpeakersCallToProposal(
                        safeArgs.eventId,
                        speakerId
                    )
                )
            ...
            .setNegativeButton(getString(R.string.edit_speaker)) { _, _ ->
                findNavController(rootView).navigate(
                    SpeakersCallFragmentDirections.actionSpeakersCallToAddSpeaker(
                        safeArgs.eventId,
                        speakerId
                    )
                )
    ...
    private fun redirectToLogin() {
        ...
        Navigation.findNavController(rootView).navigate(
            SpeakersCallFragmentDirections.actionSpeakersCallToAuth(
                getString(R.string.log_in_first),
                SPEAKERS_CALL_FRAGMENT
            )
        )
    }
