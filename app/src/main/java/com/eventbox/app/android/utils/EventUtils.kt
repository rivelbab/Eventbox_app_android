...
import com.eventbox.app.android.fragments.settings.LOCAL_TIMEZONE
import kotlinx.android.synthetic.main.dialog_login_to_like.view.*
...
object EventUtils {
    ...
    fun getDayDifferenceFromToday(date: String): Long {
        return (System.currentTimeMillis() - getTimeInMilliSeconds(
            date,
            null
        )) / (1000 * 60 * 60 * 24)
    }
