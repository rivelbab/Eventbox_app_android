...
import com.eventbox.app.android.event.RedirectToLogin
...
import com.eventbox.app.android.order.OrderCompletedFragmentArgs
import com.eventbox.app.android.order.OrderCompletedFragmentDirections
import com.eventbox.app.android.order.OrderCompletedViewModel
import kotlinx.android.synthetic.main.dialog_rate_us.view.*
        ...
        val eventClickListener: EventClickListener = object : EventClickListener {
            override fun onClick(eventID: Long, imageView: ImageView) {
                findNavController(rootView)
                    .navigate(
                        OrderCompletedFragmentDirections.actionOrderCompletedToEventDetail(eventID),
        ...
        val redirectToLogin = object : RedirectToLogin {
            override fun goBackToLogin() {
                findNavController(rootView).navigate(
                    OrderCompletedFragmentDirections.actionOrderCompletedToAuth(
                        redirectedFrom = ORDER_COMPLETED_FRAGMENT
                    )
                )
            }
        }
