...
import com.eventbox.app.android.service.DownloadInvoiceService
...
import com.eventbox.app.android.ui.payment.OrderDetailsViewHolder
import com.eventbox.app.android.ui.payment.OrderDetailsViewModel
import kotlinx.android.synthetic.main.item_enlarged_qr.view.*
...
class OrderDetailsFragment : Fragment() {
    ...
    private val ordersRecyclerAdapter: OrderDetailsRecyclerAdapter =
        OrderDetailsRecyclerAdapter()
        ...
        val eventDetailsListener = object : OrderDetailsRecyclerAdapter.EventDetailsListener {
            override fun onClick(eventID: Long) {
                findNavController(rootView).navigate(
                    OrderDetailsFragmentDirections.actionOrderDetailsToEventDetails(
                        eventID
                    )
                )
            }
    ...
    private fun downloadInvoice() {
        ...
        activity?.startService(
            DownloadInvoiceService.getDownloadService(requireContext(), downloadPath,
