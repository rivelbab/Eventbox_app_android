...
import com.eventbox.app.android.utils.EventUtils.getFormattedDateWithoutYear
import com.eventbox.app.android.adapters.RecentSearchAdapter
import com.eventbox.app.android.adapters.RecentSearchListener
    ...
    override fun onCreateView(
        ...
        rootView.timeTextView.setOnClickListener {
            findNavController(rootView).navigate(
                SearchFragmentDirections.actionSearchToSearchTime(
        ...
        rootView.locationTextView.setOnClickListener {
            findNavController(rootView).navigate(
                SearchFragmentDirections.actionSearchToSearchLocation(
                    fromFragmentName = SEARCH_FRAGMENT
                )
            )
        }
        ...
        rootView.eventTypeTextView.setOnClickListener {
            findNavController(rootView).navigate(
                SearchFragmentDirections.actionSearchToSearchType(
                    fromFragmentName = SEARCH_FRAGMENT
                )
            )
        }
