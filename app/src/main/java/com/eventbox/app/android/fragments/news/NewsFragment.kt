...
import kotlinx.android.synthetic.main.fragment_news.view.toolbarLayout
...
class NewsFragment : Fragment(), BottomIconDoubleClick {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        rootView.newsScrollView.setOnScrollChangeListener { _: NestedScrollView?, _: Int, scrollY: Int, _: Int, _: Int ->
    ...
    override fun doubleClick() = rootView.newsScrollView.smoothScrollTo(0, 0)
}
